...
The Gridwise engine processes every optimization request through a deterministic, isolated pipeline. The LLM is limited to interpreting operator language; all energy decisions, constraint enforcement, optimization, and final verification remain deterministic.
